...
class IncompleRoutes extends StatefulWidget {
  const IncompleRoutes({ Key key }) : super(key: key);

  @override
  _RouteAnalysisState createState() => _RouteAnalysisState();
}

class _RouteAnalysisState extends State<IncompleRoutes> {

  Future<List> getData() async {
    final responce = await http.get(Uri.parse(
        "https://mychoir2.000webhostapp.com/cityClean/getImcompletedRoutes.php"));
